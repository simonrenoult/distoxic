...
public class FenetreAPropos extends JWindow
{
	...
	private final static Dimension	dimension	= new Dimension(450, 380);
	...
	private JPanel top()
	{
		...
		JEditorPane auteurs = new JEditorPane("text/html", "<html>" + "<h3>" + "Auteurs :" + "</h3>"
				+ " Alexis CHRETIENNE<br />" + " Simon RENOULT" + "<h3>" + "Page Web :" + "</h3>"
				+ "<a href=\"http://distoxic.github.com/distoxic/\">Dis'Toxic</a>" + "<h3>" + "Code source :" + "</h3>"
				+ "<a href=\"https://github.com/distoxic/distoxic\">Sources</a>" + "</html>");
