...
public class EcouteurFenetreWorkspace implements ActionListener
{
	...
	/**
	 * <h4>EcouteurFenetreWorkspace est la classe qui represente l'ecouteur de
	 * la classe FenetreWorkspace</h4>
	 * <p>
	 * Cette classe contient :
	 * <ul>
	 * 
	 * <li>une instance de classe de FenetreChoixWorkspace</li>
	 * <li>une instance de classe de WorkspaceModele, permattant l'edition de
	 * l'emplacement du workspace.</li>
	 * <li>une instance de classe de JFileChooser, permettant la selection du
	 * dossier dans lequel vont s'ajouter tous les projets.</li>
	 * </ul>
	 * </p>
	 * 
	 * 
	...
	// ----------------------------------------- //
	/**
	 * Fenetre communiquant l'emplacement a choisir pour stocker tous les
	 * projets.
	 * 
	...
	/**
	 * Modele de classe WorkspaceModele. Il permet en autre la consulation et
	 * l'edition du fichier de configuration configWorkspace.txt
	 * 
	 * @see WorkspaceModele
	 */
	...
	/**
	 * Si le fichier de configuration n'est pas viable pour l'utilisateur, il
	 * faut d'abord configurer le workspace avant de lancer la fenetre
	 ...
	 * 
	 * @param f
	 *            la fenetre de selection du workspace
	 * @param modele
	 *            le modele associe a la selection du workspace
	 */
	 ...
	 * fenetre de choix du workspace.
	 * 
	 * @param e
	 *            evenement d'un objet graphique provenant de la fenetre de
	 *            choix du workspace.
	 */
	...
	/**
	 * @param lancerFenetrePrincipale
	 *            the lancerFenetrePrincipale to set
	 */
