...
public class EcouteurJtable implements TableModelListener, MouseListener, ActionListener
{
	...
	{
		/*
		 * TableColumnModel colModel = tableau.getColumnModel(); int
		 * columnModelIndex = colModel.getColumnIndexAtX(e.getX()); int
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			((ModeleTablesEditeurs) tableau.getModel()).ajouterLigneDebut(((ModeleTablesEditeurs) tableau.getModel())
					.creerLigneVierge(tableau.getColumnCount()));
		}
		else if (e.getSource() == menuContextuel.getAjouterFinTableau())
		{
			((ModeleTablesEditeurs) tableau.getModel()).ajouterLigneFin(((ModeleTablesEditeurs) tableau.getModel())
					.creerLigneVierge(tableau.getColumnCount()));
		}
		else if (e.getSource() == menuContextuel.getAjouterAvantLigneSelection())
		{
			((ModeleTablesEditeurs) tableau.getModel()).ajouterLigneAvant(
					((ModeleTablesEditeurs) tableau.getModel()).creerLigneVierge(tableau.getColumnCount()),
