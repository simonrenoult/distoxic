...
public class EcouteurMenuTextuel implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if (e.getSource() == mt.getItemsFichier()[1])
			System.out.println("Ouvrir/Ctrl+O");
		if (e.getSource() == mt.getItemsFichier()[2])
			System.out.println("Enregistrer/Ctrl+S");
		if (e.getSource() == mt.getItemsFichier()[3])
			System.out.println("Enregistrer sous/Ctrl+Maj+S");
		if (e.getSource() == mt.getItemsFichier()[4])
			System.exit(0);
		if (e.getSource() == mt.getItemsAPropos()[0])
			System.out.println("Help/F1");
	}
